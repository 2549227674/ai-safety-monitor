...
| AI 服务离线报错 (系统健壮性测试) | 设备常规工作状态 (本地 NPU 推理) |
| :---: | :---: |
| ![总览面板-AI服务离线报错](多模态设备安全巡检/00000.png) | ![总览面板-设备无异常常规状态](多模态设备安全巡检/890.png) |
| **搭载物理监控视频流 (真实监控演示)** | **检测到 PIR 运动触发 (数字孪生防区变红)** |
| ![总览面板-搭载物理监控视频流](多模态设备安全巡检/333333.png) | ![总览面板-检测到PIR运动触发高亮](多模态设备安全巡检/屏幕截图%202026-06-12%20115059.png) |
...
| 状态 A：实时巡检初始化 (待机/加载报错) | 状态 B：实时巡检加载本地 VLM 描述 (巡检点 A 描述) |
| :---: | :---: |
| ![实时巡检面板-初始化状态](多模态设备安全巡检/3333333333.png) | ![实时巡检面板-获取本地VLM描述](多模态设备安全巡检/屏幕截图%202026-06-12%20115047.png) |
...
| 状态 A：AI 推理运行日志及时延历史 | 状态 B：单帧图像视觉详细推理文本分析 |
| :---: | :---: |
| ![AI推理面板-历史记录列表](多模态设备安全巡检/123.png) | ![AI推理面板-详细推理文本](多模态设备安全巡检/屏幕截图%202026-06-12%20115036.png) |
...
| 状态 A：MPU-6500 加速度三轴与振动分数时序 | 状态 B：温湿度波动曲线与开关量状态 |
| :---: | :---: |
| ![传感器面板-振动监测状态](多模态设备安全巡检/8080.png) | ![传感器面板-温湿度监测状态](多模态设备安全巡检/屏幕截图%202026-06-12%20115028.png) |
*图 8-4：传感器面板的数据流监测图表*
...
| 状态 A：系统高危告警日志 (红框 ALERT) | 状态 B：系统巡检事件列表 (INFO) |
| :---: | :---: |
| ![告警记录列表](多模态设备安全巡检/0909.png) | ![常规巡检事件列表](多模态设备安全巡检/屏幕截图%202026-06-12%20115009.png) |
...
| 状态 A：C 闭环服务挂起异常预警 (inactive) | 状态 B：系统守护进程全部健康运行 (active) |
| :---: | :---: |
| ![设备健康面板-服务异常inactive](多模态设备安全巡检/0007777.png) | ![设备健康面板-所有服务全active](多模态设备安全巡检/屏幕截图%202026-06-12%20114934.png) |
